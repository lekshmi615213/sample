    ...
    ajaxReq.onreadystatechange = function() {
        if (ajaxReq.readyState == 4 && ajaxReq.status == 200) {
            ...
            var pieDiv = document.getElementById("project-pie"),
                ...
                numericalFirst = document.getElementById("numerical-first"),
                numericalSecond = document.getElementById("numerical-second"),
                afFirst = document.getElementById("af-first"),
                afSecond = document.getElementById("af-second"),
                pieContainer = document.getElementById("big-image");;
            ...
            drawPie(aSecond, content.projectPie, 40);
            drawPie(numericalFirst, content.projectPie, 40);
            drawPie(numericalSecond, content.projectPie, 40);
            drawPie(afFirst, content.projectPie, 40);
            drawPie(afSecond, content.projectPie, 40);
            drawPie(pieContainer, content.employees, 400);
        }
    }
    ajaxReq.send();
    $(function() {
        $("#nav-section").niceScroll({ cursorcolor: "#AEC7E8" });
    });
    var heading = $(".excited:first-child", ".active").text();
    $('#heading').html(heading);

    $("#major-container").children().click(function() {
        var collectId, pieContainer;
        pieContainer = document.getElementById("big-image");
        ...
        collectId = $(this).prop("id");
        $("#big-image").empty();
        drawPie(pieContainer, content[collectId], 400);
    });
});
